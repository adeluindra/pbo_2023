...
class FormMahasiswa:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Prodi:').grid(row=4, column=0, sticky=W, padx=5, pady=5)
        self.txtProdi = StringVar()
        Cbo = ttk.Combobox(mainFrame, width = 27, textvariable = self.txtProdi) 
        ...
        # define columns
        columns = ('idmhs', 'nim', 'nama','jk','prodi')
    ...
    def onClear(self, event=None):
        ...
        self.L.select()
        self.onReload()
        self.ditemukan = False  # Ensure that ditemukan is set to False
