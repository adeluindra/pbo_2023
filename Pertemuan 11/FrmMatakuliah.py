...
class Formmatakuliah:
    ...
    def aturKomponen(self):
        ...
        mainFrame.configure(background='cyan')
        ...
        self.P = Radiobutton(mainFrame, text='5', value='5', variable=self.txtSKS)
        self.P.grid(row=6, column=1, padx=5, pady=5, sticky=W)
        self.P = Radiobutton(mainFrame, text='6', value='6', variable=self.txtSKS)
        self.P.grid(row=7, column=1, padx=5, pady=5, sticky=W)
