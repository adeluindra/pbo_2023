...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='English:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Japanese:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hindia:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        ...
        self.btnTranslate = Button(mainFrame, text='Translate!',
            command=self.onTranslate, bg='cyan')
        self.btnTranslate.grid(row=1, column=1, sticky=W, padx=5, pady=5)
    ...
    def onTranslate(self):
        ...
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='hi')
